...
<body>
	<div class="list-group">
		...
		<a href="/erp/emp/insert"	class="list-group-item">인사등록</a> 
		<a href="/erp/dept/list.do" class="list-group-item">부서조회</a>
		<a href="/erp/emp/dept/tree.do" class="list-group-item">조직도</a>
