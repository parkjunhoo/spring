...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-Lg-10">
				<div class="container-fluid">
					<a href="/serverweb/mvc/list.do"><h1>회원목록보기</h1></a>
					<form role="form" class="form-horizontal"
						action="/serverweb/mvc/insert.do" method="POST" name="myform">
						<fieldset>
							<div id="legend">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="id" name="id" placeholder="사번"
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="point" name="point" placeholder="포인트"
										class="form-control" minlength="4" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" id="grade" name="grade" placeholder="등급"
										class="form-control" minlength="4" required>
